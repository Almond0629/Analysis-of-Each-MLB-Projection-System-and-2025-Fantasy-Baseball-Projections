...
def create_projection(df):
    atc = './Projection_model/Relievers/Fantasy/2025_ATC_Projections_Fantasy.csv'
    # tb = './Projection_model/Relievers/Fantasy/2025_THE_BAT_Projections_Fantasy.csv'
    # tbx = './Projection_model/Relievers/Fantasy/2025_THE_BAT_X_Projections_Fantasy.csv'
    # dc = './Projection_model/Relievers/Fantasy/2025_DC_Projections_Fantasy.csv'
    # zips = './Projection_model/Relievers/Fantasy/2025_ZIPS_Projections_Fantasy.csv'
    oopsy = './Projection_model/Relievers/Fantasy/2025_OOPSY_Projections_Fantasy.csv'
...
player_list_path = './Projection_model/Relievers/Fantasy/2025_Fantasy_Relievers.csv'
player_list = pd.read_csv(player_list_path)
# projection_type = 'ATC'
# path = f'./Projection_model/Relievers/{projection_type}/2025_{projection_type}_Projections.csv'
...
# filtered_df.to_csv(f'./Projection_model/Relievers/Fantasy/2025_{projection_type}_Projections_Fantasy.csv', index=False)

pitchers_df = create_projection(player_list)
pitchers_df.to_csv('./Projection_model/Relievers/Fantasy/2025_Fantasy_Relievers.csv', index=False)
